...
void Viewer::initialize( ) {
	...
	drawer->loadMV1Model( Animation::MOTION_PLAYER_KNIGHT_STORE,			"CaracterModel/knight/player_knight_store.mv1" );
	...
	drawer->loadMV1Model( Animation::MOTION_PLAYER_MONK_STORE,				"CaracterModel/monk/player_monk_store.mv1" );
	...
	drawer->loadMV1Model( Animation::MOTION_PLAYER_HUNTER_STORE,			"CaracterModel/hunter/player_hunter_attack.mv1" );
	...
	drawer->loadMV1Model( Animation::MOTION_PLAYER_WITCH_STORE,				"CaracterModel/witch/player_witch_store.mv1" );
