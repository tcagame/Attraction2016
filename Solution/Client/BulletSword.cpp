...
const double SWORD_LENGTH = 2.5 * Bullet::BULLET_SCALE;
const int RADIUS_PARTICLE = 6;
const int SWORD_PARTICLE = 3;
const double EFFECT_SCALE = 0.15 * Bullet::BULLET_SCALE;
...
bool BulletSword::update( ) {
	...
	Matrix mat = Matrix::makeTransformRotation( Vector( 0, 0, 1 ), angle / RADIUS_PARTICLE );
	for ( int i = 0; i < RADIUS_PARTICLE; i++ ) {
